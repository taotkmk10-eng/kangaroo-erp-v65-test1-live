const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/nhan_vien-CwCtXI6r.js","assets/realtimeImpactRegistry-BgzWm3W7.js","assets/searchRuntime-C7VufGsy.js","assets/runtimeCore-t2AnId75.js","assets/confirmDialog-gKnCfl1O.js","assets/toast-DvZC7wAk.js","assets/toast-BSI_6rkx.css","assets/nhan_vien-uFBI9W1M.css","assets/tao_don-CglNzdlt.js","assets/runtimeBus-2EJwbL_u.js","assets/actionLock-BTZKYVnA.js","assets/giao_hang-BKcyXmNK.js","assets/deliveryCheckSummary-BHavTlhI.js","assets/deliveryCheckSummary-U02spDCx.css","assets/giao_hang-rbIdOZsX.css","assets/hoa_don-CxvvNle5.js","assets/hoa_don-D1tINb-v.css","assets/doi_soat-D6-cs46e.js","assets/pageLayout-Deilvc9n.js","assets/dich_vu-C1QUNGCc.js"])))=>i.map(i=>d[i]);
import{a as e,i as t,n,o as r}from"./realtimeImpactRegistry-BgzWm3W7.js";import{n as i,t as a}from"./runtimeBus-2EJwbL_u.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var o=Object.freeze({name:`Kangaroo ERP`,version:`V6.5`,subtitle:`Supabase RPC-only`});function s({id:e,label:t,shortLabel:n,load:r}){let i=null;function a(){return i||=Promise.resolve().then(r).then(e=>e?.default??e).then(t=>{if(!t||typeof t.render!=`function`)throw TypeError(`MODULE_RENDER_REQUIRED:${e}`);if(t.id&&t.id!==e)throw TypeError(`MODULE_ID_MISMATCH:${e}`);return t}).catch(e=>{throw i=null,e}),i}return Object.freeze({id:e,label:t,shortLabel:n,async prefetch(){await a()},async render(e,t={}){return(await a()).render(e,t)}})}var c=Object.freeze([s({id:`nhan-vien`,label:`Nhân viên`,shortLabel:`NV`,load:()=>r(()=>import(`./nhan_vien-CwCtXI6r.js`),__vite__mapDeps([0,1,2,3,4,5,6,7]))}),s({id:`tao-don`,label:`Tạo đơn`,shortLabel:`TĐ`,load:()=>r(()=>import(`./tao_don-CglNzdlt.js`),__vite__mapDeps([8,1,9,2,10,3]))}),s({id:`giao-hang`,label:`Giao hàng`,shortLabel:`GH`,load:()=>r(()=>import(`./giao_hang-BKcyXmNK.js`),__vite__mapDeps([11,1,2,12,10,13,3,4,5,6,14]))}),s({id:`hoa-don`,label:`Hóa đơn`,shortLabel:`HĐ`,load:()=>r(()=>import(`./hoa_don-CxvvNle5.js`),__vite__mapDeps([15,1,2,12,10,13,5,6,16]))}),s({id:`doi-soat`,label:`Đối soát`,shortLabel:`ĐS`,load:()=>r(()=>import(`./doi_soat-D6-cs46e.js`),__vite__mapDeps([17,18]))}),s({id:`dich-vu`,label:`Dịch vụ`,shortLabel:`DV`,load:()=>r(()=>import(`./dich_vu-C1QUNGCc.js`),__vite__mapDeps([19,18]))})]);async function l(){let{data:t,error:n}=await e.auth.getSession();if(n)throw n;return t.session}function u(e){let t=String(e??``).trim();if(!t)throw Error(`Vui lòng nhập tài khoản.`);return t}async function d(e){let t=e.toLowerCase(),n=new TextEncoder().encode(t),r=await globalThis.crypto.subtle.digest(`SHA-256`,n);return`nv-${[...new Uint8Array(r)].map(e=>e.toString(16).padStart(2,`0`)).join(``)}@kangaroo.local`}async function f(e){let t=u(e),n=t.toLowerCase();if(/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(n)&&n.length<=240)return[n];let r=[];return/^[a-z0-9._-]+$/.test(n)&&n.length<=120&&r.push(`${n}@kangaroo.local`),r.push(await d(t)),[...new Set(r)]}async function p(t,n){let r=String(n??``);if(!r)throw Error(`Vui lòng nhập mật khẩu.`);let i=await f(t);for(let t of i){let{data:n,error:i}=await e.auth.signInWithPassword({email:t,password:r});if(!i&&n?.session)return n.session}throw Error(`Tài khoản hoặc mật khẩu không đúng.`)}async function m(){let{error:t}=await e.auth.signOut();if(t)throw t}async function h(){let{data:t,error:n}=await e.rpc(`rpc_bootstrap_current_user`);if(n)throw n;return t}function g(e,{onSubmit:t}){e.innerHTML=`
