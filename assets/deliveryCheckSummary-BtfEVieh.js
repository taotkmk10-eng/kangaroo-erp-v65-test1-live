import{a as e}from"./realtimeImpactRegistry-CDq8rbak.js";import{a as t,i as n,o as r}from"./searchRuntime-DVmPmWFL.js";import{n as i}from"./actionLock-BTZKYVnA.js";function a(e){let t=String(e??``).trim();if(!t)throw TypeError(`Thiếu ID đơn hàng để tải lịch sử.`);return r(`rpc_get_don_hang_history`,{p_id_don_hang:t},`Không tải được lịch sử đơn hàng`)}var o=Object.freeze({order:`
